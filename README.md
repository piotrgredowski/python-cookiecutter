...
A [cookiecutter](https://cookiecutter.readthedocs.io/en/latest/README.html) (project template) for rapidly developing new open source Python packages (or services). Best practices with all the modern bells and whistles included.

This repository is inspired by [Wolt Python Package Cookiecutter](https://github.com/woltapp/wolt-python-package-cookiecutter).
...
#### Automated releases for packages
...
```sh
cruft create https://github.com/piotrgredowski/python-cookiecutter
```
...
git init
git add .
git commit -m "Initial project structure from Python Cookiecutter"
```
